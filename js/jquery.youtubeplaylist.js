...
(function ( $, window, document, undefined ) {
  ...
  Plugin.prototype = {
      ...
      init: function() {
        var self = this;
        var initialItem = self.options.deepLinks && window.location.hash.indexOf('#trailer') !== -1 ? window.location.hash : null;
        ...
        $(self.element).find('li').each(function(index) {
          ...
          listItem.find('a:first').each(function() {
            ...
            link.attr('href', '#trailer' + listIndex);
            ...
            if (ytid) {
              ...
              if (self.options.addThumbs) {
                ...
                var thumbHtml = '<img width="76" height="57" src="' + thumbUrl + '" alt="' + replacedText + '" />';
